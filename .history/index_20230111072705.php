...
<body>
    ...
    <div style="margin: 0rem;">
        ...
        <div style="padding-top: 2rem;">
          ...
          <button onclick="location.href=''" type="button" class="text-white font-Montserrat font-medium font-xl rounded" style="background-color:#22215B; height:4rem; width: 50rem;">
