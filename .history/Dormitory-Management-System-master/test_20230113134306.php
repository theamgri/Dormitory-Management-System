...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT into `tenants` (`fname`,`lname`,`email`,`password`,`status`,`type`,`address`,`mobile`) VALUES('$fname','$lname','$email','$password','$status','$type','$address','$mobile')";
...
<body>
  ...
  <div class="h-10 w-full h-screen bg-scroll bg-cover bg-bottom"
    ...
    <h1 class="font-Montserrat font-bold leading-tight text-4xl mt-0 mb-2"
      style="text-align:center; color: #22215B; padding-top:0%; padding-left: 10;">Create Tenant Profile</h1>
    ...
    <form style="float:center" method="post">
      ...
      <div class="mt-2 flex items-center justify-center w-full">
        <label for="dropzone-file" style="background-color:#22215B;"
          class="flex flex-col items-center justify-center w-60 h-50 border-4 border-white border-dashed rounded-lg cursor-pointer bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-100 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            <svg aria-hidden="true" class="w-10 h-10 mb-3 text-gray-100" fill="none" stroke="currentColor"
      ...
      <div class="sm:text-center">
        <button onclick="location.href='#'" type="submit"
          ...
          style="margin-left: 0rem; background-color:#ADDDD0; height: 3rem; width: 20rem;">Send Contract</button>
      </div>
      <div class="sm:text-center pb-6">
        <button onclick="location.href='display.php'" name="submit" type="submit"
          class="mt-6 text-white bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-md px-10 py-2.5 sm:text-center "
          style="margin-left: 0rem; background-color:#ADDDD0; height: 3rem; width: 20rem;">Create Profile</button>
      </div>
