    ...
    <div class=" w-full bg-cover bg-bottom" style="height:32rem; background-image: url(/assets/dorm.png);">
        ...
        <div class="sm:items-center space-y-4 md:space-y-6 sm:p-8 sm:px-3" style="padding-top: 10rem; padding-left: 12rem">
                ...
                <div>
                  ...
                  <button type="submit" class="text-white bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-md px-10 py-2.5 sm:text-center " style="margin-left: 22rem; background-color:#ADDDD0; height: 5rem; width: 13rem;">LOGIN
                  <?php
function gohome() {
