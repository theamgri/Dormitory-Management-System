...
<body>
  ...
  <div class="text-center pt-4">
    ...
    <div class="pt-4">
      <label for="username" id="username" class="inline-block sm:text-4xl text-sm font-medium text-gray-900"
        style="color: #22215B; ">Username</label>
      <input type="lname" style="height: 5rem; width:40rem;"
    ...
    <div class="sm:ml-1.5 pt-4">
      <label for="password" id="password" class="sm:inline-block sm:text-4xl sm:font-medium text-gray-900"
        style="color: #22215B;">Password</label>
      <input type="password" style="height: 5rem; width:40rem;"
