...
<body>
    ...
    <div style="margin: 0rem;">
        ...
        <button onclick="location.href='login.php'" type="button" class="text-white font-Montserrat font-medium font-xl rounded" style="margin-top:1rem; background-color:#22215B; height:4rem; width: 50rem;">
           Login
        </button>
