...
<head>
  ...
  <?php echo '<nav class="bg-white border-gray-200 px-2 sm:px-4 py-1 rounded dark:bg-gray-100">
...
<body>
  <?php
  echo '<div class=" w-full bg-cover bg-bottom" style="height:32rem; background-image: url(/assets/dorm.png);">
