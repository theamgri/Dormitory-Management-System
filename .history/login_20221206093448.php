...
<body>
    <div class=" w-full bg-cover bg-bottom" style="height:32rem; background-image: url(/assets/dorm.png);">
        ...
        <div class="sm:items-center space-y-4 md:space-y-6 sm:p-8 sm:px-3" style="padding-top: 10rem; padding-left: 12rem">
                ...
                <div>
                    <label for="email" class="inline-block text-4xl text-sm font-medium text-gray-900" style="color: #22215B; padding-left: 2rem;">Username</label>
                    <input type="email" name="email" id="email" style="height: 4rem; width:30rem;" class="ml-6 inline-block bg-gray-10 text-gray-900 sm:text-sm rounded-full focus:ring-primary-600 focus:border-primary-600 block p-3.5 dark:bg-gray-100 dark:placeholder-gray-400  " required="">
                </div>
                <div>
                  ...
                  <button onclick="location.href='home.html'" type="submit" class="text-white bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-md px-10 py-2.5 sm:text-center " style="margin-left: 22rem; background-color:#ADDDD0; height: 5rem; width: 13rem;">LOGIN</button>
