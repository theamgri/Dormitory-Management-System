...
<div class="items-center py-10 text-center mx-6 font-Montserrat">
  <div onclick="location.href='pendbilltenants.html'" class="inline-block md:w-32 lg:w-60 sm:mx-6 mt-3 max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff";>
    <img style="padding: 2rem;" src="assets/wallet.png" alt="Sunset in the mountains">
    <div class="px-6 py-4">
...
<div class="items-center py-10 text-center bg-slate-100" style="background-color: #ffffff";>
  <h1 class="font-bold">Due Payments</h1>
  <div onclick="location.href='elecbill.html'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-2 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #fdfdfd">
    <img style="padding: 2rem;" src="/assets/electricity.png" alt="Pending Registration">
    <div class="px-6 py-4">
      <p class="font-semibold text-gray-900 text-base" >
        Electricity
      </p>
  ...
  <div onclick="location.href='waterbill.html'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-2 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff">
    <img style="padding: 2rem;" src="/assets/water.png" alt="Pending Registration">
    <div class="px-6 py-4">
      <p class="font-semibold text-gray-900 text-base">
        Water
      </p>
