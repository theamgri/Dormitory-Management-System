...
<?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div>
        ...
        <div class="pl-3 text-xl font-bold shadow-lg" style="height: 10rem; background-color:#39e4692f; border-radius: 1rem; margin-bottom: 1rem;">Room <?php echo e($room->id); ?>
            ...
            <a href="<?php echo e(route('tenants.create', $room)); ?>" class="btn btn-primary"><button type="button" class="text-white font-Montserrat font-medium font-xl rounded" style="float:right; margin-right: -5%; margin-top:2.5rem; background-color:#22215B; height:2rem; width: 7rem;">
              Add Tenant
            </button></a>
          </div>
        <?php endif; ?>
