...
<?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div>
        <?php if($reservation->room->is_occupied): ?>
            <a href="<?php echo e(route('reservation.edit', $reservation->id)); ?>">
                <div class="pl-3 text-xl font-bold shadow-lg" style="height: 100%; background-color: #e4393944; border-radius: 1rem; margin-bottom: 1rem;">
                    <button>Room <?php echo e($reservation->room->room_number); ?>
                            ...
                            <div class="inline-block font-normal font-mono content-baseline ml-4">
                                <div class="inline-block">
                                    <div class="block">
                                        ...
                                        <p class="inline-block float-right font-bold ml-4"><?php echo e($reservation->room->tenant->first_name); ?> <?php echo e($reservation->room->tenant->last_name); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="pl-3 text-xl font-bold shadow-lg" style="height: 10rem; background-color:#39e4692f; border-radius: 1rem; margin-bottom: 1rem;">
                Room <?php echo e($reservation->room->id); ?>

                <p style="float:inline-end; margin-right: 3rem;">Available</p>
                <a href="<?php echo e(route('tenants.create', $reservation)); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FRANCIS ALLEN\Dormitory-Management-System-master\resources\views/reservations/index.blade.php ENDPATH**/ ?>